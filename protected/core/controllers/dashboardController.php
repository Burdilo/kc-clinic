...
final class dashboardController extends cpLoader
{
    ...
    protected function setFolders()
    {
        ...
        $this->folders[] = array('folder' => '/exchange/', 'important' => false);
        $this->folders[] = array('folder' => '/upload_dir/', 'important' => true);
        $this->folders[] = array('folder' => DIRECTORY_SEPARATOR.PATH_PROTECTED . '/modules/', 'important' => true);
        $this->folders[] = array('folder' => DIRECTORY_SEPARATOR.PATH_PROTECTED . '/runtime/logs/', 'important' => true);
        $this->folders[] = array('folder' => DIRECTORY_SEPARATOR.PATH_PROTECTED . '/runtime/cache/', 'important' => true);
    }
    ...
    public function index()
    {
        ...
        */
        ...
        {
            if (file_exists(PATH_ROOT . $f['folder']))
            {
                $perms = substr( sprintf('%o', fileperms( PATH_ROOT . $f['folder'] )), -4) ;
                ...
                {
                    $this->folders[$k]['perms'] = substr( sprintf('%o', fileperms( PATH_ROOT . $f['folder'] )), -4) ;
                    $this->folders[$k]['owner'] = substr( sprintf('%o', fileowner( PATH_ROOT . $f['folder'] )), -4) ;
                }
            }
