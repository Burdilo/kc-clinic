				...
				<li class="attachments__pending__item" id="file_photo_{$e.id}">
					<div class="attachments__file clearfix">
						...
						<div class="attachments__file__control">
							<a href="" class="attachments__file__control__link" onclick="return cp.ajaxFileDelete({$e.id}, 'file_photo_{$e.id}');" title="Удалить файл" data-no-instant><i class="icon icon-delete"></i></a>
